...
SUNXI_CCU_N_WITH_GATE_LOCK_OFFSET_REVERSE(dpll3_clk, "dpll3" ,"hosc", 0x094,
				4, 8, 0, 13, 16,
				BIT(31), 0, CLK_GET_RATE_NOCACHE);
...
#define CCMU_AON_DXCO_CTRL              (SUNXI20_CCU_AON_BASE + 0x88)
...
{
	return (*((volatile uint32_t *)(CCMU_AON_DXCO_CTRL)) & CCMU_AON_DXCO_TRIM_MASK) >> CCMU_AON_DXCO_TRIM_START;
}
#endif

...
descriptor_error:
	...
	event_lock = hal_mutex_create();
	if (!event_lock) {
		hal_log_err("ERR: create mutex lock failed");
		ret = -ENODEV;
		goto ERR0;
	}
	//--<2>--

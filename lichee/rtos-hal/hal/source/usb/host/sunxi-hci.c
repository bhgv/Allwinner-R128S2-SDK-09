...
// fix unused-function
__attribute__((__unused__)) static int usb_get_hsic_phy_ctrl(int value, int enable)
{
	if (enable) {
		value |= (0x07 << 8);
		value |= (0x01 << 1);
...
__attribute__((__unused__)) static int init_pin(struct sunxi_hci_hcd *sunxi_hci)
{
...
__attribute__((__unused__)) static void free_pin(struct sunxi_hci_hcd *sunxi_hci)
{
	// if (sunxi_hci->drv_vbus_gpio_valid) {
...
//fix unused-function
__attribute__((__unused__)) static int sunxi_get_ohci_clock_src(struct platform_device *pdev,

...
*/
ee_u16 coremark_crcu8(ee_u8 data, ee_u16 crc )
{
...
ee_u16 coremark_crcu16(ee_u16 newval, ee_u16 crc) {
	crc=coremark_crcu8( (ee_u8) (newval)				,crc);
	crc=coremark_crcu8( (ee_u8) ((newval)>>8)	,crc);
	return crc;
}

ee_u16 coremark_crcu32(ee_u32 newval, ee_u16 crc) {
	crc=coremark_crc16((ee_s16) newval		,crc);
	crc=coremark_crc16((ee_s16) (newval>>16)	,crc);
	return crc;
}
ee_u16 coremark_crc16(ee_s16 newval, ee_u16 crc) {
	return coremark_crcu16((ee_u16)newval, crc);
}

...
#ifdef USE_DISP2
    lv_disp2_get_sizes(width, height);
#elif defined USE_SPILCD
    lv_spilcd_get_sizes(width, height);
#endif
}
...
#ifdef USE_DISP2
    lv_disp2_init(vinfo.bits_per_pixel, finfo.smem_len, &(finfo.smem_start));
#elif defined USE_SPILCD
    lv_spilcd_init(vinfo.bits_per_pixel, finfo.smem_len, &(finfo.smem_start));
#endif
}
...
#ifdef USE_DISP2
        lv_disp2_pan_display(vinfo.yoffset);
#elif defined USE_SPILCD
        lv_spilcd_pan_display(vinfo.yoffset);
#endif

...
#define STA_CMD_SET_AUTO_CONN                  0x6
#define STA_CMD_GET_SCAN_RESULTS               0x7
#define STA_CMD_GET_STATE                      0x8
#define STA_CMD_VENDOR_SEND_DATA               0x9
#define STA_CMD_VENDOR_REGISTER_RX_CB          0xa

...
typedef struct {
	...
	wmg_status_t (*sta_auto_connect)(char *);
	...
	wmg_status_t (*get_scan_results)(wifi_scan_result_t *, char *, uint32_t *, uint32_t);
...
#define WMG_STA_CMD_AUTO_CONNECT                0x4
#define WMG_STA_CMD_GET_INFO                    0x5
#define WMG_STA_CMD_LIST_NETWORKS               0x6
#define WMG_STA_CMD_REMOVE_NETWORKS             0x7
#define WMG_STA_CMD_SCAN_PARAM                  0x8
#define WMG_STA_CMD_SCAN_RESULTS                0x9
#define WMG_STA_CMD_REGISTER_MSG_CB             0xa
#define WMG_STA_CMD_GET_STATE                   0xb
#define WMG_STA_CMD_VENDOR_SEND_DATA            0xc
#define WMG_STA_CMD_VENDOR_REGISTER_RX_CB       0xd
...
#define WMG_STA_ACT_AUTO_CONNECT        0x3
#define WMG_STA_ACT_GET_INFO            0x4
#define WMG_STA_ACT_LIST_NETWORKS       0x5
#define WMG_STA_ACT_REMOVE_NETWORKS     0x6

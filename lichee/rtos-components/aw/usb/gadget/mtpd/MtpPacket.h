...
struct MtpPacket {
	...
	size_t mBufferSize;
	size_t mPacketSize;
	// int (*read)(struct MtpDevHandle *handle, struct MtpPacket *mPacket);
	// int (*write)(struct MtpDevHandle *handle, struct MtpPacket *mPacket);
	...
	void (*setEventCode) (MtpEventCode code, struct MtpPacket *mPacket);
